...
$(document).ready(function () {
    ...
    new Switchery(document.querySelector('.sm_disable_checked'), {
        size: 'small',
        disabled: true,
        color: '#0fb0c0',
        jackColor: '#fff'
    ...
    new Switchery(document.querySelector('.md_toggle'), {
        color: '#0fb0c0',
    ...
    new Switchery(document.querySelector('.md_colored'), {
        color: '#0fb0c0',
        secondaryColor: '#ffb300',
        jackColor: '#fff',
        jackSecondaryColor: '#0fb0c0'
    });

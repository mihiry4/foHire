...
<body <% if(type.equals("index")){%> class="body1"
                                     style="background-size:cover;width:100%;background-image: url('assets/img/aprt.jpg'); background-attachment: fixed; background-position:center; background-repeat: no-repeat;" <%}%>>


<nav class="navbar navbar-light navbar-expand-md" data-aos="fade-up" data-aos-duration="550" data-aos-once="true"
     style="<% if(type.equals("index"))	{out.print("color:#212529;background-color:rgba(0,0,0,0.5); z-index:1000;");}	else{ out.print("color:#212529;background-color:#ffffff;border-bottom:1px gray solid;z-index:1000;");} %>">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse menu" id="navcol-2">
            <form class="form-inline <% if(type.equals("index")){%>d-none<%}else{%>d-inline-block<%}%> mr-auto searchbar"
                  method="post" target="_self" style="box-shadow:2px 2px 5px rgb(58,58,58);width:50%;"
                  action="borrow.jsp">       <%--ToDo:Borrow page for top search bar--%>
                <div class="form-group" style="margin-bottom:0px;padding:5px;"><label for="search-field">
                    <i class="fa fa-search" style="color:rgb(200,159,12);font-size:18px;"></i></label><input
                        class="form-control form-control-sm search-field" type="search" name="item" placeholder="Search"
                        autocomplete="on" id="search-field">
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false"
                       href="#" style="color:#f8b645;">Help</a>
                ...
                <li class="nav-item" role="presentation"><a class="nav-link" href="#" style="color:rgb(248,182,69);"
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle nav-link dropdown-toggle msg" data-toggle="dropdown" aria-expanded="false"
                       href="#" style="color:#f8b645;">Notifications
                    ...
                    <div class="dropdown-menu dropdown-menu-right not" role="menu">
                        ...
                        <%--</div>--%>
                        <%--</a>--%>
                        <a class="dropdown-item notmsgtop seeall" role="presentation" href="allNotifications.jsp">See
                            all</a>
                    </div>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false"
                       href="#" style="color:#f8b645;">Profile</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="font-weight: bold">
                    ...
                    <button id="log" class="btn btn-primary" style="background-color:#f8b645;margin-top:10px;">Login
                    </button>

...
public final class product {
    ...
    public void lend(@NotNull Connection connection, int user_id, String product_name, String category, String description, String region, String city, String price, String deposit, String availFrom, String availTill) throws SQLException {
        product_id = 0;
...
//                    AvailTill = new java.sql.Date(Integer.parseInt(availTill.substring(6, 10)), Integer.parseInt(availTill.substring(3, 5)), Integer.parseInt(availTill.substring(0, 2)));
    ...
    public void setImg(@NotNull Connection connection, int tot_img) throws SQLException {
    ...
    public void getBookedDates(@NotNull Connection connection) throws SQLException {
        LocalDate[][] Dates;
    ...
    public void getLender(@NotNull Connection connection) throws SQLException {
        String[] userDetails;
    ...
    public boolean fillDetails(@NotNull Connection connection) throws SQLException {        //Returns whether product is available or not
        boolean ans;
